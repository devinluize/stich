...
<div class="body">
    <div class="col-md-9" style="font-size: 2vw; margin: 20px 0px 20px 100px">Tailoring Profile</div>
    ...
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-md-6" style="position: relative; margin-left: 50px">
                ...
                <div style="font-size: 1vw">adsaisdhasgdayudvauda</div>
            </div>

            <div class="col-md" style="position: relative">
                <button style="margin: 70px 0px 50px 170px; width: 6vw; border-style: none; border-radius: 5px; background-color: #D9D9D9; font-size: 1vw" class="editbtn">Edit<img src="{{ asset('image/editlogo.png') }}" style="margin-left: 5px"></button>
            </div>
        </div>
    </div>   
    ...
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-md" style="position: relative; width: 100%">
                <button style="margin: 15px 0px 0px 518px; width: 6vw; border-style: none; border-radius: 5px; background-color: #D9D9D9; font-size: 1vw" class="editbtn">Edit<img src="{{ asset('image/editlogo.png') }}" style="margin-left: 5px"></button>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            <div class="col-md" style="position: relative">
                ...
                <div style="margin-bottom: 10px; color: #858282; font-size: 3vh">{Auth()::name}</div>
                <div style="font-size: 3vh">Email Address</div>
                <div style="margin-bottom: 10px; color: #858282; font-size: 3vh">Devin.Suhandi2004.@gmail.com</div>
            </div>

            <div class="col-md" style="position: relative; margin-left: 50px">
                <div style="font-size: 3vh">Last Name</div>
                <div style="color: #858282; margin-bottom: 10px; font-size: 3vh">Suhandi</div>
                <div style="font-size: 3vh">No telepon</div>
                <div style="color: #858282; margin-bottom: 10px; font-size: 3vh">13192371937</div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-md" style="position: relative; width: 100%; justify-content: end">
                <button style="margin: 15px 0px 0px 518px; width: 6vw; border-style: none; border-radius: 5px; background-color: #D9D9D9; font-size: 1vw" class="editbtn">Edit<img src="{{ asset('image/editlogo.png') }}" style="margin-left: 5px"></button>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            <div class="col-md" style="position: relative">
                ...
                <div style="margin-bottom: 10px; color: #858282; font-size: 3vh">Indonesia</div>
                <div style="font-size: 3vh">Postal Code</div>
                <div style="margin-bottom: 10px; color: #858282; font-size: 3vh">15148</div>
            </div>

            <div class="col-md" style="position: relative; margin-left: 50px">
                <div style="font-size: 3vh">City</div>
                <div style="color: #858282; margin-bottom: 10px; font-size: 3vh">Tangerang</div>
                <div style="font-size: 3vh">Home</div>
                <div style="color: #858282; margin-bottom: 10px; font-size: 3vh">Somewhere</div>
            </div>
        </div>
    </div>
</div>

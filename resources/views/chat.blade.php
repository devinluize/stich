            ...
            <div class="col-md-4 col-xl-3 chat">
                <div class="card mb-sm-3 mb-md-0 contacts_card" style="align-items:center">
                    ...
                    @if (Auth::user()->isTailor == true)
                        <h1 style="font-size: 20px">{{ $data_user->username }}</h1>
                    @endif
                    @if (Auth::user()->isTailor == false)
                        <h1 style="font-size: 20px">{{ $data_user->user->username }}</h1>
                    @endif
                    {{-- <h1 style="font-size: 20px">{{ $data_user->user->username }}</h1> --}}
                    <br>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <a onclick="window.location.href = '{{ route('seetailor', ['id' => $tailor_id]) }}'"
                    ...
                    <div class="row" style="margin-top: 10px; margin-left: 15px">
                        ...
                        <div class="col-md-10">
                            @if (Auth::user()->isTailor == true)
                                <h1 style="font-size: 20px">{{ $data_user->phone_number }}</h1>
                            @endif
                            @if (Auth::user()->isTailor == false)
                                <h1 style="font-size: 20px">{{ $data_user->user->phone_number }}</h1>
                            @endif
                        </div>
                    </div>
                    <br>
                    ...
                    @if (Auth::user()->isTailor == false)
                        <button type="button" class="btn btn-primary"
                            onclick="window.location.href = '{{ route('dealuser') }}'"
                            style="background-color: #FF9B53; width: 100px">Deal</button>
                    @endif
                    @if (Auth::user()->isTailor == true)
                        <button type="button" class="btn btn-primary"
                            onclick="window.location.href = '{{ route('tailorDeal') }}'"
                            style="background-color: #FF9B53; width: 100px">Deal price</button>
                    @endif
            ...
            <div class="col-md-8 col-xl-6 chat">
                <div class="card">
                    <div class="card-header msg_head">
                        <div class="d-flex bd-highlight">
                            <div class="user_info">
                                ...
                                {{-- <span>{{ $data_user->user->username }}</span> --}}
                                @if (Auth::user()->isTailor == true)
                                    <h1 style="font-size: 20px">{{ $data_user->username }}</h1>
                                @endif
                                @if (Auth::user()->isTailor == false)
                    ...
                    <div class="card-body msg_card_body">
                        {{-- @use App\Models\User --}}
                        @php($user_id = App\Models\User::find(Auth::id()))

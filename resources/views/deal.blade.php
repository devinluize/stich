...
<body>
    <div class="container">
        ...
        <div class="text">
            <h2 style="margin-bottom: 5px; margin-top: 0;">Deal Made!</h2>
            <h1 style="margin-top: 0;">Rp {{ $data->productprice }}</h1>
        </div>
    </div>
    <div class="buttons">
        {{ $id = $data->user_id }}
        <a href="{{ route('chat', ['id' => $data->user_id]) }}" class="button1">Back to chat</a>
        <a href="{{ route('transaction') }}" class="button2">Continue to checkout</a>
    </div>
